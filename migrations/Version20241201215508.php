 ...
 */
final class Version20241201215508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lunar_phase_ritual (lunar_phase_id INT NOT NULL, ritual_id INT NOT NULL, INDEX IDX_E3432E26230D4B59 (lunar_phase_id), INDEX IDX_E3432E26F8922643 (ritual_id), PRIMARY KEY(lunar_phase_id, ritual_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
